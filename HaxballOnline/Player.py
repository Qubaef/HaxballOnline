...
class Player(CirclePhysical):
    ...
    def update(self):
        ...
        # check if circle collides with any other circle saved in gamesas
        for circ in self.game.members:
            if circ != self:
    ...
    def mode_ball_control(self):
        # turn down ball_control reduce the bounce
